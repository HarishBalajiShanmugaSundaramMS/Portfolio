...
exists = os.path.isfile('/Users/harishbalaji/documents/mycode/mycode/mypythoncode/Farmers/AllFarmers.csv')
if exists:
    os.remove('/Users/harishbalaji/documents/mycode/mycode/mypythoncode/Farmers/AllFarmers.csv')
else:
...
plt.savefig('/Users/harishbalaji/documents/mycode/mycode/mypythoncode/Farmers/AllFarmers.svg',
            format='svg', dpi=1200)
