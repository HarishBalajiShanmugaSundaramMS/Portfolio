...
if os.path.exists('/Users/harishbalaji/documents/mycode/mycode/mypythoncode/SocialNetworks/BetweennessCentrality.csv'):
    os.remove(
        '/Users/harishbalaji/documents/mycode/mycode/mypythoncode/SocialNetworks/BetweennessCentrality.csv')

# adds the header portion of the csv file
with open(os.path.join(dir, 'BetweennessCentrality.csv'), 'a+') as farmers_file:
